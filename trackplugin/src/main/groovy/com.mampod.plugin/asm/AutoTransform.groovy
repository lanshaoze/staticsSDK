...
import com.mampod.plugin.util.AutoTextUtil
...
public class AutoTransform extends Transform {
    ...
    static void printCopyRight() {
        ...
        println '#######################################################################'
        println '##########                                                    '
        println '##########         欢迎使用 Jack-Lu® (' + VERSION + ')无埋点编译插件'
        println '##########                                                    '
        println '#######################################################################'
        println '##########                                                    '
        println '##########                      插件配置参数                    '
        ...
        println '##########                 -isOutputModifyFile:' + GlobalConfig.getParams().isOutputModifyFile
...
//                            Logger.info(target.getAbsolutePath())
                            ...
                            // 写到build文件夹
                            if (GlobalConfig.isOutputModifyFile) {
                                savemodifedJar(en.getValue())
                            }
                            en.getValue().delete()
                    }
                }
    ...
    static savemodifedJar(File file) {
        File pluginTmpDir = new File(GlobalConfig.project.buildDir, 'trace-point')
