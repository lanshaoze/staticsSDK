...
//                [Opcodes.ALOAD, Opcodes.ALOAD]))
     ...
     */
    public final
    static HashMap<String, LogMethodCell> sActivityMethods = new HashMap<>()
    static {
//
...
//                [Opcodes.ALOAD]))
//
//        sActivityMethods.put('onStop()V', new LogMethodCell(
//                'onStop',
//                '()V',
//                '',//
//                'trackActivityStop',
...
//
    ...
    static {
//
////        sFragmentMethods.put('onFragmentShow(ZLjava/lang/String;Ljava/lang/String;)V', new LogMethodCell(
////                'onFragmentShow',
...
////                0, 4,
////                [Opcodes.ALOAD, Opcodes.IALOAD, Opcodes.ALOAD, Opcodes.ALOAD]))
//
//
//
